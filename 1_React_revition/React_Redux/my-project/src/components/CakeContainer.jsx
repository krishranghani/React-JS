...
const CakeContainer = () => {
  ...
  return (
    <div>
      ...
      <button className='bg-black text-white w-44 ml-[570px] rounded-full' onClick={() => dispatch(buy_cake())}>Cake Decrement</button>
      <br/>
      <button className='bg-black text-white w-44 ml-[570px] rounded-full' onClick={() => dispatch(buy_choco())}>Choco Decrement</button>
    </div>
  )
}
