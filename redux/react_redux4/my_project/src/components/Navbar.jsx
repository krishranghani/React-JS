        ...
        <div className="relative w-full bg-gradient-to-r from-orange-500 via-white to-green-600">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                ...
                <div className="hidden lg:inline-block relative ">
                    ...
                    <span className="absolute transform translate-x-1/2 -translate-y-1/2 border rounded-full px-1 top-0 right-0  bg-black text-white text-xs">{count}</span>
                </div>
                        ...
                        <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="px-5 pb-6 pt-5">
                                ...
                                <div className='relative inline-block w-full'>
                                    ...
                                    <span className="absolute top-5 right-0 transform translate-x-1/2 -translate-y-1/2 border rounded-full px-1 bg-black text-white text-xs">5</span>
                                </div>
                            </div>
                        </div>
                    </div>
